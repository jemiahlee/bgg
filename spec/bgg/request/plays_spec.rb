...
describe Bgg::Request::Plays do
  ...
  def request_test_helper
    ...
    expect( subject.get ).to be_instance_of Bgg::Plays
  end
    ...
    context 'username request' do
      ...
      describe "#date" do
        context 'single' do
          ...
          it do
            ...
            expect( subject.date(date).get ).to be_instance_of Bgg::Plays
          end
        end
        ...
        context 'range' do
          ...
          it do
            ...
            expect( subject.date(date_range).get ).to be_instance_of Bgg::Plays
          end
        end
      end
      ...
      describe "#page" do
        ...
        it do
          ...
          expect( subject.page(2).get ).to be_instance_of Bgg::Plays
        end
      end
    end
